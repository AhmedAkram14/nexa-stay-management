...
export async function getBookings({ filter, sortBy, page }) {
  let query = supabase
    .from("bookings")
    .select(
      "id, created_at , startDate , endDate , numNights , numGuests , status , totalPrice , guestId , cabinId , hasBreakfast , observations , isPaid , cabins(name) , guests(fullName , email)",
      { count: "exact" },
    );
